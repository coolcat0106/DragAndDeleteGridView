package com.coolcat.dragviewanddelete;
...
MyAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DragGridView dragGridView = (DragGridView) findViewById(com.coolcat.dragviewanddelete.R.id.dragGridView);
        textView = (TextView) findViewById(com.coolcat.dragviewanddelete.R.id.textview);
